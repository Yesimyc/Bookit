...
public class Environment {
    ...
    static {//static block first execution
        Properties properties = null;
        String environment = ConfigurationReader.getProperty("environment");
        try {
            String path = String.format("src/test/resources/environment/%s.properties", environment);//% concats
...
//final variable nobody can change
