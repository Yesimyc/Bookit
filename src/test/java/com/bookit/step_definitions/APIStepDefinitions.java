...
//user should be able to see 18 rooms
...
//user verifies that response status code is 200
    ...
    @Then("user deletes previously added student")
    ...
    public void user_should_be_able_to_see_all_room_names() {
      ...
      //will not work. list is unmodifiable. so we can not change the order
